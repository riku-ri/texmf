...
\expandafter\gdef\csname math lr delay\endcsname#1\mrt{
\expandafter\def\csname math lr def\endcsname{#1}\mrt
}
...
\setbox0=\hbox{\csname math lr def\endcsname}
\dimen0=\ht0
...
\left#1\vbox to\dimen1{\hbox{$\csname math lr def\endcsname$}}\right#2
}}
