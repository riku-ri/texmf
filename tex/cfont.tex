...
\gdef\fontsize#1{
\csname [rikuri^fontsize]\endcsname={#1}\csname
\the\csname [rikuri^font]\endcsname\endcsname
\csname[rikuri^jfontsize]\endcsname={#1}\csname
\the\csname[rikuri^jfont]\endcsname\endcsname
}
