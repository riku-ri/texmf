...
\def\afont#1=#2|#3{\csname\string\FONT\endcsname\font#1={#2}}% ascii font
\def\ufont#1=#2|#3{\csname\string\FONT\endcsname\jfont#1={#2}}% unicode font
...
{\the\csname\string#1\string\fontname\expandafter\string\csname\the\csname^\string#1\endcsname\endcsname\endcsname \the\csname\string#1\string\fontsize\endcsname}%
}%
\def\afontsize#1{%
...
%%%%
%\ufont\a=[lulix-monoflow.ttf]|{at 15pt}\relax
%\afont\a=[msmincho.ttc]|{at 30pt}\relax
%%\cfont\a=[msmincho.ttc]|{30pt}\relax
%\afontsize{scaled 5000}
