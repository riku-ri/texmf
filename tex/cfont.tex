...
\gdef\untilgroup#1#2{#1}%
\gdef\afont#1=#2|#3{% ascii font
...
\def#1{\the\csname\string#1\endcsname\csname\string\afont\endcsname={\expandafter\notcsname\string#1}\csname\string\ufont\endcsname={\the\csname\string\ufont\endcsname}}%
}%
\gdef\ufont#1=#2|#3{% unicode font
...
\def#1{\the\csname\string#1\endcsname\csname\string\afont\endcsname={\the\csname\string\afont\endcsname}\csname\string\ufont\endcsname={\expandafter\notcsname\string#1}}%
}%
\gdef\cfont#1=#2|#3{% both ascii font and unicode font
\afont#1=#2|{#3}\relax%
\ufont#1=#2|{#3}\relax%
\csname\string#1\endcsname={\csname\string\font\string#1\endcsname\csname\string\jfont\string#1\endcsname}%
...
\gdef\fontsize#1{\afontsize{#1}\ufontsize{#1}}%
%
\gdef\tiny{5pt}%
\gdef\scriptsize{7pt}%
