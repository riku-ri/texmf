...
\long\gdef\display#1{\listcount=0
\ifx#1\magstep
...
\long\expandafter\gdef\csname chalign with\string\magstep\endcsname#1\relax#2{
#1
\csname chalign halign\endcsname{#2}
}
\long\expandafter\gdef\csname chalign halign\endcsname#1{{
